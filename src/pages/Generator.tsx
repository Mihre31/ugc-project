    ...
    <div className="min-h-screen text-white p-6 md:p-12 mt-28">
      <form onSubmit={handleGenerate} className="max-w-4xl mx-auto mb-40">
        <Title
          ...
          description="Upload your model and product image to generate stunning UGC, short-form videos and social medis posts"
        />
            ...
            <div className="mb-4 text-gray-300">
              ...
              <div className="flex gap-3">
                <RectangleVerticalIcon
                  ...
                  className={`p-2.5 size-16 bg-white/6 rounded transition-all ring-2 ring-transparent cursor-pointer ${aspectRatio === "9:16" ? "ring-violet-500/50 bg-white/10" : ""}`}
                />
                <RectangleHorizontalIcon
                  onClick={() => setAspectRatio("16:9")}
                  className={`p-2.5 size-16 bg-white/6 rounded transition-all ring-2 ring-transparent cursor-pointer ${aspectRatio === "16:9" ? "ring-violet-500/50 bg-white/10" : ""}`}
                />
              </div>
            </div>
            <div className="mb-4 text-gray-300">
              ...
              <textarea
                ...
                placeholder="Describe how thee narration to be."
                className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none resize-none transition-all"
              />
            </div>
          </div>
